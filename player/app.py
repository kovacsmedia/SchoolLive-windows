...
# Csengőhangok ismert hosszai ms-ben (fallback ha szerver nem küldi)
BELL_DURATIONS_MS = {
    "kibecsengo.mp3":  5_000,
    "jelzocsengo.mp3": 4_000,
    "dingdong.mp3":    3_000,
}
...
class SchoolLiveApp:
    ...
    def _activate(self) -> None:
        ...
        def _fetch_info():
            ...
            if snap_port:
                ...
                print("[App] Snap port lekérés sikertelen")
    ...
    def _on_play(self, msg: dict) -> None:
        ...
        duration_ms = msg.get("durationMs")   # overlay timer
        ...
        def _execute(ctx=ctx):
            ...
            print(f"[App] PLAY action={action} snap={snap_usable} dur={dur_ms}ms")
            ...
            if action == "TTS":
                ...
                # dur_ms=None esetén az overlay a STOP_PLAYBACK-ig marad
                ...
                bell_ms = dur_ms if dur_ms else BELL_DURATIONS_MS.get(sound_file, 5000)
                self.ui.show_bell_overlay(bell_ms)
                if not snap_usable and url:
    ...
    def _bell_tick_loop(self) -> None:
        """Csak offline fallback – ha nincs WS kapcsolat."""
        while True:
            time.sleep(5)
            ...
            if not self._online:
                ...
                bell_ms    = BELL_DURATIONS_MS.get(sound_file, 5000)
                self.ui.show_bell_overlay(bell_ms)
                audio.play_bell(
